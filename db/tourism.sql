...
-- Dumping data for table tourism.pr_icon: ~4 rows (approximately)
...
-- Dumping data for table tourism.pr_kategori_promosi: ~3 rows (approximately)
...
INSERT INTO `pr_kategori_sarana_prasarana` (`id_kategori_sarana_prasarana`, `kategori_sarana_prasarana_ina`, `kategori_sarana_prasarana_eng`, `icon`) VALUES
	(1, 'Transportasi Darat', 'Inland Transportation', 3),
	(2, 'Transportasi Udara', 'Air Transportation', 1),
	(3, 'Transportasi Laut', 'Water Transportation', 2),
	(4, 'Hotel', 'Hotel', 4),
	(5, 'Bandara', 'Airport', 1);
...
-- Dumping data for table tourism.pr_lokasi_wisata: ~2 rows (approximately)
...
-- Dumping data for table tourism.pr_lokasi_wisata_gambar: ~4 rows (approximately)
...
INSERT INTO `pr_lokasi_wisata_gambar` (`id_pr_lokasi_wisata_gambar`, `id_lokasi_wisata`, `gambar`, `deskripsi_ina`, `deskripsi_eng`) VALUES
	(9, 1, 'dive-wakatobi.jpg', NULL, NULL),
	(10, 1, 'Reefs-within-Wakatobi-sanctuary_aerial-view_photo-by-Didi-Lotze.jpg', NULL, NULL),
	(11, 1, 'dive-wakatobi.png', NULL, NULL),
	(12, 1, 'Reefs-within-Wakatobi-sanctuary_aerial-view_photo-by-Didi-Lotze.png', NULL, NULL);
...
-- Dumping data for table tourism.pr_lokasi_wisata_tag_sarana: ~2 rows (approximately)
...
INSERT INTO `pr_promosi` (`id_promosi`, `id_promosi_kategori`, `promosi_ina`, `promosi_eng`, `deskripsi_ina`, `deskripsi_eng`, `cover`, `tanggal_promosi`, `tanggal_kadarluarsa`) VALUES
	(1, 4, 'Promosi Keunggulan Wisata Wakatobi Belum Optimal', 'Promotion of Tourism Excellence Wakatobi Not Optimal', '<p style="text-align:justify">WAKATOBI, Beritakendari.com-Menjelang perhelatan KPDT Expo 2013, Kabupaten Wakatobi selaku tuan rumah mulai mempersiapkan berbagai hal. Salah satunya, persiapan penyelenggaraan event nasional itu dan promosi wisata Wakatobi. Sekretaris Mentri Pembangunan Daerah Tertinggal (PDT) H.Muhammad Nurdin mengungkapkan hal itu dihadapan Muspida Wakatobi, akhir pekan kemarin.</p>\r\n\r\n<p style="text-align:justify">Selain mendorong untuk terlepas dari ketertinggalan sesuai tujuan penyelenggaan KPDT Expo 2013, berdasarkan potensinya Kabupaten Wakatobi memiliki keunggulan yang tidak dimiliki daerah lain bahkan bila dibandingkan dengan negara tetangga masih lebih unggul.</p>\r\n\r\n<p style="text-align:justify">Menurut Nurdin, kekurangan Wakatobi selama 9 tahun ini sejak dinyatakan mekar dari Kabupaten Buton, promosinya yang belum optimal. Publikasi Wakatobi diberbagai media cetak, elektronik dan online masih belum memadai. &ldquo;Melalui even nasional KPDT Expo 2013 ini, kita akan memperomosikan Wakatobi secara luas baik nasional maupun internasional,&rdquo; terangnya.</p>\r\n\r\n<p style="text-align:justify">Data menunjukkan, Indonesia yang berpenduduk 245 juta jiwa namun jumlah wisatawannya hanya sekitar 7 jutaan dan hanya sebagian kecil yang berkunjung ke Wakatobi sementara Malaysia yang hanya berpenduduk 25 juta jiwa jumlah wisatawannya berkisar 35 juta. Dari segi potensi, Wakatobi itu lebih unggul. &ldquo;Apa masalahnya? promosi, makanya publikasi itu penting,&rdquo;jelasnya.</p>\r\n\r\n<p style="text-align:justify">Nurdin mengungkapkan, ruang promosi melalui kegiatan KPDT Expo 2013 ini cukup terbuka. Selain akan dihadiri oleh 183 kabupaten tertinggal di Indonesia, kegiatan ini juga akan disiarkan secara LIVE oleh stasiun TV nasional, berbagai media media cetak, online skala lokal dan nasional juga turut ambil bagian dalam event ini. &nbsp;Dengan begitu, Wakatobi diharapkan bisa menyedot perhatian publik secara luas.</p>\r\n\r\n<p style="text-align:justify">&ldquo;Pointnya, selain bisa mendongkrak minat wisatawan untuk berkunjung ke Wakatobi, kita juga berharap para investor bisa lebih melirik Wakatobi sebagai sasaran investasi yang menjanjikan,&ldquo; imbuhnya. (BK)</p>\r\n', '<p>WAKATOBI, Beritakendari.com-Ahead KPDT Expo 2013 event, Wakatobi as the host began to prepare for a variety of things. One of them, the preparation for the national event and tourism promotion Wakatobi. Secretary of the Ministry of Rural Development (PDT) H.Muhammad Nurdin reveal it before the officials Wakatobi, last weekend.&nbsp;</p>\r\n\r\n<p>In addition to pushing for apart from dropping to the purpose penyelenggaan KPDT Expo 2013, based on the potential Wakatobi has the advantage that no other area even when compared with neighboring countries is still superior.&nbsp;</p>\r\n\r\n<p>According to Nurdin, Wakatobi deficiency for 9 years since stated bloom of Buton, promotion is not optimal. Wakatobi publications in various print, electronic and online is still inadequate. &quot;Through this national event KPDT Expo 2013, we will promote the Wakatobi widely both nationally and internationally,&quot; he explained.&nbsp;</p>\r\n\r\n<p>Data shows, Indonesia with a population of 245 million, but the number of travelers there is only about 7 millions and only a small portion to visit the area while Malaysia has a population of only 25 million people wisatawannya number around 35 million. In terms of potential, it is superior to Wakatobi. &quot;What&#39;s the problem? promotion, so it is important publication, &quot;he explained.&nbsp;</p>\r\n\r\n<p>Nurdin said space through activities promotional KPDT Expo 2013 is pretty open. In addition will be attended by 183 underdeveloped districts in Indonesia, this event will also be broadcast LIVE by national TV stations, print media, online national and local scales also take part in this event. By doing so, Wakatobi is expected to be widespread public attention.&nbsp;</p>\r\n\r\n<p>&quot;The point, in addition to boost interest for the tourists to visit the area, we also hope that the investors could be glanced Wakatobi as a promising investment targets,&quot; he added. (BK)</p>\r\n', NULL, '2014-10-26', '2014-11-15'),
	(5, 1, 'Wakatobi Ubah Pola Promosi Pariwisata', 'Wakatobi Tourism Promotion Pattern Change', '<p><span style="color:rgb(0, 0, 0); font-family:verdana,arial,sans-serif">Wangiwangi (Antara News) - Akses yang sulit dijangkau masih menjadi kendala promosi pariwisata di Kabupaten Wakatobi, Sulawesi kata Asisten II Sekretaris Daerah Kabupaten Wakatobi Nadar.</span><br />\r\n<br />\r\n<span style="color:rgb(0, 0, 0); font-family:verdana,arial,sans-serif">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &quot;Akses masih menjadi persoalan untuk &#39;leading sector&#39; pariwisata kita,&quot; kata Nadar saat diskusi di salah satu resor di Wangi-Wangi, Wakatobi, Rabu.</span><br />\r\n<br />\r\n<span style="color:rgb(0, 0, 0); font-family:verdana,arial,sans-serif">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Nadar menjelaskan baru ada dua bandara yang beroperasi aktif, yakni Bandara Matahora dan Bandara Tomia.</span><br />\r\n<br />\r\n<span style="color:rgb(0, 0, 0); font-family:verdana,arial,sans-serif">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Bandara Matahora pun, lanjut dia, baru beroperasi selama satu tahun dan baru dilengkapi dengan ruang tunggu.</span><br />\r\n<br />\r\n<span style="color:rgb(0, 0, 0); font-family:verdana,arial,sans-serif">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Sementara itu, Bandara Tomia yang dibangun sejak 1999 hanya melayani penerbangan privat dengan pesawat sewaan.</span><br />\r\n<br />\r\n<span style="color:rgb(0, 0, 0); font-family:verdana,arial,sans-serif">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &quot;Kalau Tomia, ada penerbangan dari Bali langsung ke Bandara Tomia empat bulan sekali, tapi menggunakan pesawat &#39;carteran&#39;,&quot; ucapnya. &nbsp;</span><br />\r\n<br />\r\n<span style="color:rgb(0, 0, 0); font-family:verdana,arial,sans-serif">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Saat ini, rute penerbangan untuk mencapai Wakatobi dari Jakarta memakan waktu sekitar enam jam dengan dua kali transit di Makassar dan Kendari.</span><br />\r\n<br />\r\n<span style="color:rgb(0, 0, 0); font-family:verdana,arial,sans-serif">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Dia mengatakan PT Garuda Indonesia berencana membuat rute Makassar, Bau-Bau, kemudian Wakatobi pada Juli 2014.</span><br />\r\n<br />\r\n<span style="color:rgb(0, 0, 0); font-family:verdana,arial,sans-serif">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &quot;Jadi, kami berharap nanti tidak ada lagi orang Jakarta harus pagi-pagi buta berangkat ke tempat kami,&quot; ujarnya.</span><br />\r\n<br />\r\n<span style="color:rgb(0, 0, 0); font-family:verdana,arial,sans-serif">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Menurut Nadar, akses merupakan faktor penting untuk menunjang potensi pariwisata Wakatobi yang unggul akan wisata laut dan perikanannya.</span><br />\r\n<br />\r\n<span style="color:rgb(0, 0, 0); font-family:verdana,arial,sans-serif">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &quot;Daya tarik kita, &#39;core&#39; nya (intinya) kan laut, menampilkan &#39;unlimited spot&#39; (titik tak terbatas) sepanjang pulau, karena itu, investasi untuk bandara ini tidak main-main,&quot; tuturnya.</span><br />\r\n<br />\r\n<span style="color:rgb(0, 0, 0); font-family:verdana,arial,sans-serif">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Selain akses, infrastruktur, seperti jalanan dan listrik juga masih menjadi perhatian Pemda untuk bisa mengembangkan pariwisata laut.</span><br />\r\n<br />\r\n<span style="color:rgb(0, 0, 0); font-family:verdana,arial,sans-serif">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Luas wilayah laut memang mendominasi dari keseluruhan luas wilayah kabupaten, yakni seluas 18.377 kilometer persegi atau sebesar 97 persen dari 19.200 kilometer persegi, sementara daratan hanya 823 kilometer persegi.</span><br />\r\n<br />\r\n<span style="color:rgb(0, 0, 0); font-family:verdana,arial,sans-serif">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Untuk itu, sektor kelautan, perikanan dan sektor pariwisata berbasis bahari menjadi sektor andalan daerah.</span></p>\r\n', '<p>Wangiwangi (Antara News) - Access hard to reach is still a constraint promotion of tourism in Wakatobi, Sulawesi, said Second Assistant District Secretary Wakatobi Nadar.&nbsp;</p>\r\n\r\n<p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&quot;Access is still a problem for the &#39;leading sector&#39; of our tourism,&quot; Nadar said during a discussion at one of the resorts in Wangi Wangi, Wakatobi, Wednesday.&nbsp;</p>\r\n\r\n<p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Nadar explained there are only two airports that are active, the Airport and Airport Matahora Tomia.&nbsp;</p>\r\n\r\n<p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Matahora service was, he added, have been operational for a year and a newly equipped with a lounge area.&nbsp;</p>\r\n\r\n<p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Meanwhile, Tomia service built since 1999 only serve private flights with leased aircraft.&nbsp;</p>\r\n\r\n<p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&quot;If Tomia, there are direct flights from Bali to Tomia service four months, but using the plane &#39;chartered&#39;,&quot; he said.&nbsp;</p>\r\n\r\n<p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Currently, the flight route from Jakarta to reach Wakatobi takes about six hours to two transit in Makassar and Kendari.&nbsp;</p>\r\n\r\n<p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;He said PT Garuda Indonesia plans to create a route Makassar, Bau-Bau, then Wakatobi in July 2014.&nbsp;</p>\r\n\r\n<p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&quot;So, we hope there will not be no more people have to Jakarta early morning we went to the place,&quot; he said.&nbsp;</p>\r\n\r\n<p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;According to Nadar, access is an important factor to support the tourism potential to be a superior Wakatobi marine tourism and fisheries.&nbsp;</p>\r\n\r\n<p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&quot;The appeal of our &#39;core&#39; it (essentially) the sea, featuring &#39;unlimited spot&#39; (infinite point) along the island, therefore, the investment for the airport is not messing around,&quot; he said.&nbsp;</p>\r\n\r\n<p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;In addition to access, the infrastructure, such as roads and electricity are still a concern for the local government to develop marine tourism.&nbsp;</p>\r\n\r\n<p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Dominate the sea area of the total area of ??the district, which is an area of ??18 377 square kilometers or 97 percent of the 19,200 square kilometers, while the mainland is only 823 square kilometers.&nbsp;</p>\r\n\r\n<p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;To that end, the marine sector, fisheries and marine-based tourism sector into a regional primary sector.</p>\r\n', NULL, '2014-10-29', '2014-10-23');
...
-- Dumping data for table tourism.pr_promosi_gambar: ~2 rows (approximately)
/*!40000 ALTER TABLE `pr_promosi_gambar` DISABLE KEYS */;
INSERT INTO `pr_promosi_gambar` (`id_promosi_gambar`, `id_promosi`, `gambar`) VALUES
	(1, 1, 'Wakatobi-l.jpg'),
	(2, 5, 'Wakatobi-l.jpg');
