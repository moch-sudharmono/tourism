            ...
            <div class="form-actions">
                <div class="row">
                    <div class="col-md-offset-2 col-md-12">
                        <button type="submit" class="btn default" id="reject" name="reject" value="Reject">Tolak / Reject</button>
                        <button type="submit" class="btn blue" id="approved" name="approved" value="Approved">Terima / Approved</button>
                    </div>
                </div>
            </div>
        </form>
