...
<!-- BEGIN PAGE CONTENT-->
        <form id="UploadForm2" action="<?php echo base_url() ?>upload/do_upload" method="POST" enctype="multipart/form-data">
...
<script>
	...
	$('#UploadForm2').fileupload({
		...
		dataType: 'json',
		context: $('#UploadForm2')[0],
		acceptFileTypes: /(\.|\/)(<?php echo $filetype ?>)$/i,
