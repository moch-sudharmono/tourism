										...
										* </span>
										...
										<div class="col-md-4">
											<select class="form-control select2me" name="cbo_cat">
												...
												<option value="<?php echo $value["id_kategori_sarana_prasarana"]?>"><? echo $value["kategori_sarana_prasarana_ina"]."/".$value["kategori_sarana_prasarana_eng"]?></option>
                                                <?php } ?>
											</select>
										</div>
									</div>
...
jQuery(document).ready(function() { 
	...
	$('#AddNew').click(function(e){
		...
		document.getElementById('form_infrastructure').action="<?php echo base_url()."index.php/".$modul."/insert_infrastructure"?>";
	});
